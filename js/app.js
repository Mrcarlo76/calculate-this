...
,{name:"Word Finder",url:"word-finder.html"},{name:"Savings Calculator",url:"savings.html"},{name:"Tip Calculator",url:"tip.html"},{name:"Running Pace Calculator",url:"pace.html"},{name:"Percentage Change Calculator",url:"percentage-change.html"},{name:"Loan-to-Value (LTV) Calculator",url:"ltv.html"}];
